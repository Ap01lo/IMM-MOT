...
def reorder_detection(detector_path, dataset_path, dataset_name='NuScenes',
                      dataset_version='test', detector_name='CenterPoint'):
    """
...
if __name__ == "__main__":
    reorder_detection(
        dataset_path='/data/nuscenes/NuScenes_trainval/',
        detector_path='/home/mot/project/IMM_MOT/data/detector/raw_detector/infos_val_10sweeps_withvelo_filter_True.json',
